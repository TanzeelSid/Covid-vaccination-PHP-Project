...
$sel = mysqli_query($connect, "SELECT * FROM patient WHERE firstname='$pat'");
...
if (isset($_POST['book'])) {
    ...
    if (empty($sym)) {
        ...
        $query = "INSERT INTO appointment (firstname, lastname, email, phone, appointment_date, vaccine, status, date_booked) VALUES ('$firstname', '$lastname', '$email', '$phone', '$date', '$sym', 'Pending', NOW())";
    ...
    <div class="row">
        ...
        <div class="col-md-6 jumbotron">
            <form method="post">
                ...
                <label for="symptoms">Vaccines</label>
<select name="sym" id="symptoms" class="form-control">
