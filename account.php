...
if (count($error)==0){
    ...
    $query = "INSERT INTO patient (firstname, lastname, email, phonenumber,password,date_reg,profile) 
              VALUES ('$firstname', '$lastname', '$email','$phone' ,'$password',NOW(),'patient.jpg')";
...
<div class="flex">
        <div class="wrapper">
            ...
            <br><br>
            <span>already have an account! <a href="patientlogin.php">click here</a> </span>
        </div>
    </div>
